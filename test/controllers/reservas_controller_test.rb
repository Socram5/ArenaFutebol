...
class ReservasControllerTest < ActionController::TestCase
  ...
  test "should create reserva" do
    assert_difference('Reserva.count') do
      post :create, reserva: { dia: @reserva.dia, email: @reserva.email, horario: @reserva.horario, nome: @reserva.nome, telefone: @reserva.telefone }
    end
  ...
  test "should update reserva" do
    patch :update, id: @reserva, reserva: { dia: @reserva.dia, email: @reserva.email, horario: @reserva.horario, nome: @reserva.nome, telefone: @reserva.telefone }
    assert_redirected_to reserva_path(assigns(:reserva))
  end
